...
public class AccountFragmentViewModel extends AndroidViewModel {
    ...
    @Inject
    public AccountFragmentViewModel(BaseApplication context, AppRepository appRepository) {
        super(context);
    ...
    public void logOut() {
        ...
        appRepository.logOut().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
