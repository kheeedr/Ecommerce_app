...
import com.khedr.ecommerce.presentation.adapters.OrderedProductsAdapter;
...
public class OrderDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void setAddressExpanded(boolean addressExpanded) {
        ...
        if (!addressExpanded) {
            Animations.animZoomOut(this, b.expandableLayoutOrderDetails);
            b.ivOrderDetailsExpandAddress.setRotation(90);
        } else {
            Animations.animZoomIn(this, b.expandableLayoutOrderDetails);
