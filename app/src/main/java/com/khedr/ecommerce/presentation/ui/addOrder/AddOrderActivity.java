...
import com.khedr.ecommerce.presentation.adapters.SelectAddressAdapter;
import com.khedr.ecommerce.presentation.ui.address.AddAddressActivity;
import com.khedr.ecommerce.presentation.ui.address.AddressViewModel;
...
public class AddOrderActivity extends AppCompatActivity implements View.OnClickListener, SelectAddressAdapter.OnItemClickListener {
    ...
    protected void onResume() {
        ...
        addOrderViewModel.estimateOrder( new EstimateOrderRequest(isUsePoints(), getValidVoucherId()));
    ...
    public void onClick(View v) {
        if (v == b.btAddOrderBack) {
            ...
            if (promoCode.isEmpty()) {
                ...
                addOrderViewModel.validatePromoCode( promoCode);
            }
        }
    ...
    public void onExpandClick(int position, SelectAddressAdapter.AddressesViewHolder holder) {
        ...
        if (addressAdapter.getAddressesList().get(position).isExpanded()) {
            ...
            Animations.animZoomOut(this, holder.b.expandableLayoutSelectAddress);
            addressAdapter.getAddressesList().get(position).setExpanded(false);


        } else {
            Animations.animZoomIn(this, holder.b.expandableLayoutSelectAddress);
    ...
    public void setValidVoucherId(Integer validVoucherId) {
        ...
        addOrderViewModel.estimateOrder( new EstimateOrderRequest(isUsePoints(), validVoucherId));
    }
    ...
    public void setUseVoucher(boolean useVoucher) {
        ...
        if (useVoucher) {
            ...
            Animations.animZoomIn(this, b.layoutCheckVoucher);
        } else {
            ...
            Animations.animZoomOut(this, b.layoutCheckVoucher);
            b.etCheckVoucher.setText("");
            addOrderViewModel.estimateOrder( new EstimateOrderRequest(isUsePoints(), null));
        }
    ...
    public void setUsePoints(boolean usePoints) {
        ...
        if (usePoints) {
            ...
            addOrderViewModel.estimateOrder( new EstimateOrderRequest(true, getValidVoucherId()));
            ...
            addOrderViewModel.estimateOrder( new EstimateOrderRequest(false, getValidVoucherId()));
        }
    }
}
