...
public class LoginViewModel extends AndroidViewModel {
    ...
    @Inject
    public LoginViewModel(BaseApplication context, AppRepository appRepository) {
        super(context);
    ...
    void userLogin(UserDataForLoginRequest user) {
        ...
        appRepository.login(user).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
